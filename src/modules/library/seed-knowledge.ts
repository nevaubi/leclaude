...
6. Citing Westlaw for a case that has a reporter citation.`,
  },
  {
    ...
    description: "Calloway & Reyes house style for briefs, memos and transactional documents: citation formatting, record cites, defined terms, numbering, [VERIFY] convention and the drafting-agent review categories.",
...
This note governs every document produced at Calloway & Reyes, including drafts generated by the Office agents. Where it departs from the Bluebook, this note controls.
...
- The firm: "Calloway & Reyes LLP" on first use; "the Firm" thereafter in engagement letters; "C&R" only in internal notes.
